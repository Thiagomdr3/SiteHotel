...
namespace SiteHotel.Controllers
{
    public class EnderecosController : Controller
    {
        ...
        {
            var context = _context.Endereco.Include(e => e.Pessoa);
        ...
        public async Task<IActionResult> Create([Bind("Id,Cep,Rua,Complemento,Bairro,Cidade,Uf,Telefone,PessoaId")] Endereco endereco)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Cep,Rua,Complemento,Bairro,Cidade,Uf,Telefone,PessoaId")] Endereco endereco)
        {
            if (id != endereco.Id)
            {
                return NotFound();
